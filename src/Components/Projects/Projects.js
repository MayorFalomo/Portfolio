  ...
  return (
    <div id="projects" className="ProjectsContainer">
      ...
      <div className="projectWrapper" >
        ...
        <div className="subProjectLeft" data-aos="fade-up" style={{ backgroundImage: "url(./tweeks.png)", backgroundPosition: "center", backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }}>
        ...
        <div className="subProjectRightCon" >
          <div className="subProjectRight" data-aos="fade-up" style={{ backgroundImage: "url(./blogaroo.png)", backgroundPosition: "center", backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }}>
            ...
            <div className="flexLink">
              ...
              <a target="_blank" href="https://github.com/MayorFalomo/Blogaroo-FrontEnd" rel="noreferrer">
                {<IoLogoGithub className="githubLink" />} Github{" "}
              </a>
          </div>
            </div>
        ...
        <div className="subProjectLeft"  style={{backgroundImage: "url(./cinemaflix.png)", backgroundPosition: "center", backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundColor: 'black'}} data-aos="fade-up">
            <div className='overLayLeft' ></div>
          <div className="parallaxText">
            <h1> CinemaFlix </h1>
            ...
            <div className="flexLinks">
              <a target="_blank" href="https://cinema-flix.netlify.app/" rel="noreferrer">
                {<MdLogout className="netlifyLink" />} Demo
              </a>
              <a target="_blank" href="https://github.com/MayorFalomo/cinemaFlix" rel="noreferrer">
                ...
                <div className="subProjectRightCon" >
        <div className="subProjectRight"  data-aos="fade-up" style={{backgroundImage: "url(./medleyGames.jpg)", backgroundPosition: "center", backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}>
              <div className='overLayRight' ></div>
            <div id="parallax">
            <h1>Medley Games </h1>
        ...
        <div className="subProjectLeft" style={{backgroundImage: "url(./urban.jpg)", backgroundPosition: "center", backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}  data-aos="fade-up">
          <div className='overLayLeft' ></div>
          <div className="parallaxText">
            <h1>Nft Dashboard</h1>
            ...
            <div className="flexLinks">
              ...
              <a target="_blank" href="https://github.com/MayorFalomo/Urban-Nft-Dashboard" rel="noreferrer">
                ...
                <div className="subProjectRightCon" >
        <div className="subProjectRight" style={{backgroundImage: "url(./travelBuddy.jpg)", backgroundPosition: "center", backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}} data-aos="fade-up">
            <div className='overLayRight' ></div>
            <div id="parallax">
            <h1>Travel Buddy </h1>
        ...
        <div className="subProjectLeft" style={{backgroundImage: "url(./orpheus.png)", backgroundPosition: "center", backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}  data-aos="fade-up">
          <div className='overLayLeft' ></div>
          <div className="parallaxText">
            <h1>Orpheus</h1>
            ...
            <div className="flexLinks">
              <a id="black" target="_blank" href="https://orpheus-nft.netlify.app/" rel="noreferrer">
                {<MdLogout className="netlifyLink" />} Demo{" "}
              </a>
              <a id="black" target="_blank" href="https://github.com/MayorFalomo/Orpheus-landing-page" rel="noreferrer">
                {<IoLogoGithub className="githubLink" />} Github{" "}
              </a>
            </div>
            </div>
                ...
                <div className="subProjectRightCon" >
        <div className="subProjectRight" style={{backgroundImage: "url(./google.png)", backgroundPosition: "center", backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}} data-aos="fade-up">
            <div className='overLayRight' ></div>
            <div id="parallax">
            <h1>Google Clone </h1>
            ...
            <span>HTML, React, CSS, API, Firebase </span>
              <div className="flexLink">
              <a target="_blank" href="https://googlebase.netlify.app/" rel="noreferrer">
                {<MdLogout className="netlifyLink" />} Demo{" "}
              </a>
              <a target="_blank" href="https://github.com/MayorFalomo/GoogleBase" rel="noreferrer">
                {<IoLogoGithub className="githubLink" />} Github{" "}
              </a>
            </div>
            </div>
        ...
        <div className="subProjectLeft" style={{backgroundImage: "url(./swishUpdated.png)", backgroundPosition: "center", backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}  data-aos="fade-up">
                    <div className='overLayLeft' ></div>
          <div className="parallaxText">
            <h1>Swish</h1>
            ...
            <div className="flexLinks">
              ...
              <a id="black" target="_blank" href="https://github.com/MayorFalomo/Swish-Weather-App" rel="noreferrer">
                {<IoLogoGithub className="githubLink" />} Github{" "}
              </a>
            </div>
            </div>
                ...
                <div className="subProjectRightCon" >
        <div className="subProjectRight" style={{backgroundImage: "url(./quiz.png)", backgroundPosition: "center", backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}  data-aos="fade-up">
          <div className='overLayRight' ></div>
            <div id="parallax">
            <h1>Quiz App </h1>
              ...
              <span>Next JS, CSS </span>
            <div className="flexLink">
              <a target="_blank" href="https://trivial-quiz-app.netlify.app/" rel="noreferrer">
                {<MdLogout className="netlifyLink" />} Demo{" "}
              </a>
              <a target="_blank" href="https://github.com/MayorFalomo/Quiz-App" rel="noreferrer">
                {<IoLogoGithub className="githubLink" />} Github{" "}
              </a>
            </div>
            </div>
         ...
         <div className="subProjectLeft" style={{backgroundImage: "url(./StoreBay.png)", backgroundPosition: "center", backgroundSize: 'cover', backgroundRepeat: 'no-repeat'}}  data-aos="fade-up">
                    <div className='overLayLeft' ></div>
          <div className="parallaxText">
            <h1>StoreBay</h1>
            ...
            <span>Next JS, CSS </span>
            <div className="flexLinks">
              <a id="black" target="_blank" href="https://store-bay.netlify.app/" rel="noreferrer">
                {<MdLogout className="netlifyLink" />} Demo{" "}
              </a>
              <a id="black" target="_blank" href="https://github.com/MayorFalomo/StoreBay" rel="noreferrer">
                {<IoLogoGithub className="githubLink" />} Github{" "}
              </a>
            </div>
            </div>
